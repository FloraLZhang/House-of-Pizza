...
const ProfileForm = ({ user, onSave }: ProfileFormProps) => {
  ...
  return (
    <div className='grid grid-cols-6 gap-4'>
      ...
      <form className='col-span-4' onSubmit={(e) => onSave(e, { name: userName, image: userImage, phone, streetAddress, zipcode, city, state, isAdmin })}>
        ...
        <AddressInputs
          addressProps={{ phone, streetAddress, city, state, zipcode }}
