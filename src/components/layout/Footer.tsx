    ...
    <footer className="bg-gray-950 pt-12">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-6 px-10 lg:px-48">
        <div className="col-span-full lg:col-span-1 lg:block">
          <Link href="/" className='text-primary text-2xl font-josefin'>House of Pizza</Link>
        ...
        <div>
          ...
          Passionate about crafting unforgettable pizzas.</p>
        </div>
        ...
        <div>
          ...
          <p className="mt-6 text-gray-400">
            Monday - Sunday</p>
          <p className="mt-2 text-gray-400">11:00am - 9:00pm</p>
        </div>
          ...
          <div className="mt-6 text-gray-400">
            <ul className="space-y-2">
              <li className="inline-flex space-x-4">
                ...
                <span>1 Pink St, Boston, MA, 02215</span>
              </li>
              <li className="inline-flex space-x-4">
                <span><PhoneIcon className={"w-6"} /></span>
                <span>+1 857-888-8888</span>
              </li>
              <li className="inline-flex space-x-4">
                <span><MailIcon className={"w-6"} /></span>
                <span>info@houseofpizza.com</span>
              </li>
            </ul>
          </div>
        </div>
